              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.house_number}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.flat_number}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/client_addresses/client_addresses-edit/?id=${item.id}`}
                  pathView={`/client_addresses/client_addresses-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && client_addresses.length === 0 && (
...
export default ListClient_addresses;
