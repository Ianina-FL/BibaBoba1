...
export const loadColumns = async (
  ...
  const hasUpdatePermission = hasPermission(user, 'UPDATE_DISH_INGREDIENTS');
      ...
      getActions: (params: GridRowParams) => {
        return [
          <ListActionsPopover
            ...
            pathEdit={`/dish_ingredients/dish_ingredients-edit/?id=${params?.row?.id}`}
            pathView={`/dish_ingredients/dish_ingredients-view/?id=${params?.row?.id}`}
            key={1}
