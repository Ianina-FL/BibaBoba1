...
const ListSources = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_SOURCES');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.source_name}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/sources/sources-edit/?id=${item.id}`}
                  pathView={`/sources/sources-view/?id=${item.id}`}
