...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/sources/sourcesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureSourcesCols';
...
const TableSampleSources = ({
  ...
  useEffect(() => {
    if (sourcesNotify.showNotification) {
      notify(sourcesNotify.typeNotification, sourcesNotify.textNotification);
    }
  }, [sourcesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/sources/sources-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {sources && Array.isArray(sources) && !showGrid && (
        <ListSources
          sources={sources}
          loading={loading}
...
export default TableSampleSources;
