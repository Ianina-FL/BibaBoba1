              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter.sourcesOneListFormatter(item.source)}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>OrderReceived</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.dateTimeFormatter(item.order_received)}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>OrderReady</p>
                    <p className={'line-clamp-2'}>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>OrderDelivered</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.dateTimeFormatter(item.order_delivered)}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>OrderRejected</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.dateTimeFormatter(item.order_rejected)}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>Repeated</p>
                    <p className={'line-clamp-2'}>
