...
const ListDishes = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_DISHES');
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>Cutlery</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.booleanFormatter(item.cutlery)}
                    </p>
                  </div>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/dishes/dishes-edit/?id=${item.id}`}
                  pathView={`/dishes/dishes-view/?id=${item.id}`}
