...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/dishes/dishesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureDishesCols';
...
const TableSampleDishes = ({
  ...
  useEffect(() => {
    if (dishesNotify.showNotification) {
      notify(dishesNotify.typeNotification, dishesNotify.textNotification);
    }
  }, [dishesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/dishes/dishes-view/?id=${id}`);
  };
...
export default TableSampleDishes;
