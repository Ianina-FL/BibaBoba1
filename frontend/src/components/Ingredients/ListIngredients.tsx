...
const ListIngredients = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_INGREDIENTS');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/ingredients/ingredients-edit/?id=${item.id}`}
                  pathView={`/ingredients/ingredients-view/?id=${item.id}`}
