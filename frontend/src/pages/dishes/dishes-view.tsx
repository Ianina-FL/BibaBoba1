...
import { fetch } from '../../stores/dishes/dishesSlice';
...
const DishesView = () => {
  ...
  return (
    <>
      <Head>
        <title>{getPageTitle('View dishes')}</title>
      </Head>
      <SectionMain>
        <SectionTitleLineWithButton
          icon={mdiChartTimelineVariant}
          title={removeLastCharacter('View dishes')}
          main
        >
          {''}
        </SectionTitleLineWithButton>
        <CardBox>
          ...
          <FormField label='Cutlery'>
            <SwitchField
              field={{ name: 'cutlery', value: dishes?.cutlery }}
...
DishesView.getLayout = function getLayout(page: ReactElement) {
  return (
